...
async function RetornarDadosMercadoPadoJsonMes(req, res) {
    ...
    const query = "SELECT name, avatarImage, data, valor FROM gastos_mensais_notion WHERE MONTH(data) = MONTH(CURDATE()) AND YEAR(data) = YEAR(CURDATE()) ORDER BY data DESC;";
