...
async function fetchData(req, res) {
    try {
        ...
        const response = await axios.get('https://lojamirante.com.br/api/getCouponUse?codigo=CupomP5,MIRANTE5,VOLTA5,carrinho5,presenteespecial,duda10,figueredo10,vinicius10,emfoco10,BLACK10');
